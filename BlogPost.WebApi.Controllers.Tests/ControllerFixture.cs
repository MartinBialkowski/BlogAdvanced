...
namespace BlogPost.WebApi.Controllers.Tests
{
    ...
    {
        public DbContextOptions<BlogPostContext> Options { get; private set; } = null!;
        public IEnumerable<StudentResponse> ExpectedStudents { get; private set; } = null!;
        public IMapper Mapper { get; private set; } = null!;
        private IEnumerable<Student> allStudents = null!;
